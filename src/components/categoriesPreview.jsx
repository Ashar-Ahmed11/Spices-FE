...
const CategoriesPreview = () => {
  ...
  const finalCategory = categories.filter((e)=>{return !e.firstHeading.includes("*")})


  return (
    <div>
      <div className="container-fluid">
      <p data-aos="fade-up" data-aos-duration="1000" className="h1 text-center my-5" style={{ fontFamily: 'Sagrantino', color: color }}>Our Collection</p>
        <div className="row">
              ...
              <div class="carousel-inner rounded-4">
                <div class="carousel-item active">
                  ...
                  <div className='h-100 w-100 text-center' style={{ zIndex: '30',position:"absolute",top:"0px",display:'flex',flexDirection:'column',justifyContent:'center'}} data-aos="fade-up" data-aos-duration="2000" >
                    ...
                    <span style={{ fontFamily: 'Sagrantino',color:"white",fontSize:"180%",lineHeight:'1' }}>{e.firstHeading}</span>
